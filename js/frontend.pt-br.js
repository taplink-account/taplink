...
window.$app.defineLanguage("pt-br", 0, {"Январь":"Janeiro","Февраль":"Fevereiro","Март":"Março","Апрель":"Abril","Май":"Maio","Июнь":"Junho","Июль":"Julho","Август":"Agosto","Сентябрь":"Setembro","Октябрь":"Outubro","Ноябрь":"Novembro","Декабрь":"Dezembro","ПН":"Seg","ВТ":"Ter","СР":"Qua","ЧТ":"Qui","ПТ":"Sex","СБ":"Sab","ВС":"Dom","Сделано на":"Feito por","Промокод":"Cupom","Закрыть":"Fechar","Активировать промокод":"Ativar cupom","Я понял":"Entendi","Юридическая информация":"Informações legais","шт.":"peças","Подтвердить":"Confirmar","Доставка":"Frete","Самовывоз":"Pickup","Другие страны":"Other countries","Итого":"Total","Контакты":"Contatos","Подтверждение":"Confirmation","Применить":"Aplique","Корзина":"Carrinho","Корзина пуста":"Empty cart","Поиск по названию":"Pesquisar por nome","Все товары":"Todos os produtos","В магазине пока отсутствуют товары":"There are no products in the shop","Скидка":"Discount","-- Не выбрано --":"-- No escolhido --","Добавить в корзину":"Adicionar ao carrinho","Вернуться в каталог":"Retornar ao catálogo","Оформить заказ":"Efetuar pedido","Товар добавлен в корзину":"Item added to cart","Перейти в корзину":"Go to Cart","Продолжить покупки":"Continue shopping","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"A página está indisponível para visualização de todos. Para resolver esse problema, você precisa conectar um perfil ou nome de domínio","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Infelizmente, esta função foi bloqueada porque o proprietário da página não pagou por ela a tempo. Se possível, informe o proprietário da página  sobre este problema","Заголовок":"Título","Дни":"Dias","Часы":"Horas","Минуты":"Minutos","Введите корректный email":"Entre com um email válido","Секунды":"Segundos","Необходимо заполнить поле":"Você deve preencher o campo","Введите корректный номер телефона":"Digite um número de telefone válido"});