...
window.$app.defineLanguage("de", 0, {"Январь":"Januar","Февраль":"Februar","Март":"März","Апрель":"April","Май":"Mai","Июнь":"Juni","Июль":"Juli","Август":"August","Сентябрь":"September","Октябрь":"Oktober","Ноябрь":"November","Декабрь":"Dezember","ПН":"MO","ВТ":"DI","СР":"MI","ЧТ":"DO","ПТ":"FR","СБ":"SA","ВС":"SO","Сделано на":"Gemacht von","Промокод":"Promo code","Закрыть":"Schließen","Активировать промокод":"Activate promo code","Я понял":"Got it","Юридическая информация":"Rechtliche Information","шт.":"st.","Подтвердить":"Bestätigen","Доставка":"Lieferung","Самовывоз":"Selbstabholung","Другие страны":"Andere Länder","Итого":"Gesamtsumme","Контакты":"Kontakte","Подтверждение":"Bestätigung","Применить":"Anwenden","Корзина":"Warenkorb","Корзина пуста":"Warenkorb ist leer","Поиск по названию":"Nach Namen suchen","Все товары":"Alles anzeigen","В магазине пока отсутствуют товары":"Momentan ausverkauft","Скидка":"Discount","-- Не выбрано --":"-- Nichts ausgewählt --","Добавить в корзину":"In den Warenkorb","Вернуться в каталог":"Zurück zur Auswahl","Оформить заказ":"Bestellen","Товар добавлен в корзину":"Zum Warenkorb hinzugefügt","Перейти в корзину":"Zum Warenkorb","Продолжить покупки":"Weiter einkaufen","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"The page is unavailable for viewing all. To resolve this issue you need to connect a profile or domain name","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Unfortunately, this function was blocked because the owner of the page did not pay for it in time. If possible, please let the owner of the page know about this issue","Заголовок":"Headline","Дни":"Tage","Часы":"Stunden","Минуты":"Minuten","Введите корректный email":"Bitte richtige E-Mail eingeben","Секунды":"Sekunden","Необходимо заполнить поле":"Bitte Feld ausfüllen","Введите корректный номер телефона":"Bitte richtige Telefonnummer eingeben"});