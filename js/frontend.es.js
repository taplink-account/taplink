...
window.$app.defineLanguage("es", 0, {"Январь":"Enero","Февраль":"Febrero","Март":"Marzo","Апрель":"Abril","Май":"Mayo","Июнь":"Junio","Июль":"Julio","Август":"Agosto","Сентябрь":"Septiembre","Октябрь":"Octubre","Ноябрь":"Noviembre","Декабрь":"Diciembre","ПН":"LU","ВТ":"MA","СР":"MI","ЧТ":"JU","ПТ":"VI","СБ":"SA","ВС":"DO","Сделано на":"Hecho por","Промокод":"Cupón","Закрыть":"Cerrar","Активировать промокод":"Activar un cupón","Я понял":"Entiendo","Юридическая информация":"Información legal","шт.":"pzas","Подтвердить":"Confirmar","Доставка":"Entrega","Самовывоз":"Recogida","Другие страны":"Otros países","Итого":"Total","Контакты":"Contactos","Подтверждение":"Confirmación","Применить":"Aplicar","Корзина":"Carrito","Корзина пуста":"Carro vacío","Поиск по названию":"Búsqueda","Все товары":"Todos los productos","В магазине пока отсутствуют товары":"No hay productos en la tienda","Скидка":"Discount","-- Не выбрано --":"-- No elegido --","Добавить в корзину":"Agregar al carrito","Вернуться в каталог":"Regresar al catalogo","Оформить заказ":"Hacer un pedido","Товар добавлен в корзину":"Artículo agregado al carrito","Перейти в корзину":"Ir al carrito","Продолжить покупки":"Seguir comprando","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"La página no está disponible para ver todo. Para resolver este problema, debe conectar un perfil o nombre de dominio","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Lamentablemente, esta función fue bloqueada porque el dueño de la página no pagó por ella en ningún momento. De ser posible hágale saber al dueño de la página sobre el problema","Заголовок":"Título","Дни":"Días","Часы":"Horas","Минуты":"Minutos","Введите корректный email":"Introduzca un correo electrónico válido","Секунды":"Segundos","Необходимо заполнить поле":"Debes rellenar el campo","Введите корректный номер телефона":"Ingrese un número de teléfono válido"});