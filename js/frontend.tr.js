...
window.$app.defineLanguage("tr", 0, {"Январь":"January","Февраль":"February","Март":"March","Апрель":"April","Май":"May","Июнь":"June","Июль":"July","Август":"August","Сентябрь":"September","Октябрь":"October","Ноябрь":"November","Декабрь":"December","ПН":"Mon","ВТ":"Tue","СР":"Wed","ЧТ":"Thu","ПТ":"Fri","СБ":"Sat","ВС":"Sun","Сделано на":"Powered by","Промокод":"Promo code","Закрыть":"Yakın","Активировать промокод":"Activate promo code","Я понял":"Got it","Юридическая информация":"Yasal bilgi","шт.":"adet.","Подтвердить":"Onaylamak","Доставка":"Teslim","Самовывоз":"Pikap","Другие страны":"Diğer ülkeler","Итого":"Toplamda","Контакты":"Bize Ulaşın","Подтверждение":"Onay","Применить":"Uygulamak","Корзина":"Sepet","Корзина пуста":"Sepet boş","Поиск по названию":"İsme göre ara","Все товары":"Tüm mallar","В магазине пока отсутствуют товары":"Mağazada henüz ürün bulunmuyor","Скидка":"Discount","-- Не выбрано --":"-- Seçilmedi --","Добавить в корзину":"Sepete ekle","Вернуться в каталог":"Kataloğa geri dön","Оформить заказ":"Sipariş ver","Товар добавлен в корзину":"Ürün sepete eklendi","Перейти в корзину":"Sepete git","Продолжить покупки":"Alışverişe devam et","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"The page is unavailable for viewing all. To resolve this issue you need to connect a profile or domain name","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Unfortunately, this function was blocked because the owner of the page did not pay for it in time. If possible, please let the owner of the page know about this issue","Заголовок":"Headline","Дни":"Günler","Часы":"Saat","Минуты":"Dakika","Введите корректный email":"Geçerli bir e-posta giriniz","Секунды":"Saniye","Необходимо заполнить поле":"Alanı doldurmalısın","Введите корректный номер телефона":"Geçerli bir telefon numarası girin"});