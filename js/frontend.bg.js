...
window.$app.defineLanguage("bg", 0, {"Январь":"January","Февраль":"February","Март":"March","Апрель":"April","Май":"May","Июнь":"June","Июль":"July","Август":"August","Сентябрь":"September","Октябрь":"October","Ноябрь":"November","Декабрь":"December","ПН":"Mon","ВТ":"Tue","СР":"Wed","ЧТ":"Thu","ПТ":"Fri","СБ":"Sat","ВС":"Sun","Сделано на":"Powered by","Промокод":"Промокод","Закрыть":"Затвори","Активировать промокод":"Приложи промокод","Я понял":"Got it","Юридическая информация":"Юридическа информация","шт.":"бр.","Подтвердить":"Потвърди","Доставка":"Доставка","Самовывоз":"Взимане от място","Другие страны":"Други държави","Итого":"Общо","Контакты":"Контакти","Подтверждение":"Потвърждаване","Применить":"Приемам","Корзина":"Количка","Корзина пуста":"Количката е празна","Поиск по названию":"Търсене по име","Все товары":"Всички продукти","В магазине пока отсутствуют товары":"В магаизна още няма продукти","Скидка":"Отстъпка","-- Не выбрано --":"-- Not chosen --","Добавить в корзину":"Добави в количка","Вернуться в каталог":"Връщане в каталог","Оформить заказ":"Приключване на поръчка","Товар добавлен в корзину":"Продуктът е добавен в количката","Перейти в корзину":"Преглед на количка","Продолжить покупки":"Продължаване на пазаруването","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"The page is unavailable for viewing all. To resolve this issue you need to connect a profile or domain name","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Unfortunately, this function was blocked because the owner of the page did not pay for it in time. If possible, please let the owner of the page know about this issue","Заголовок":"Headline","Дни":"Дни","Часы":"Часа","Минуты":"Минути","Введите корректный email":"Enter a valid email","Секунды":"Секунди","Необходимо заполнить поле":"Задължително поле","Введите корректный номер телефона":"Въведете валиден телефонен номер"});