...
window.$app.defineLanguage("th", 0, {"Январь":"มกราคม","Февраль":"กุมภาพันธ์","Март":"มีนาคม","Апрель":"เมษายน","Май":"พฤษภาคม","Июнь":"มิถุนายน","Июль":"กรกฎาคม","Август":"สิงหาคม","Сентябрь":"กันยายน","Октябрь":"ตุลาคม","Ноябрь":"พฤศจิกายน","Декабрь":"ธันวาคม","ПН":"จ.","ВТ":"อ.","СР":"พ.","ЧТ":"พฤ.","ПТ":"ศ.","СБ":"ส.","ВС":"อา.","Сделано на":"ทำโดย","Промокод":"คูปอง","Закрыть":"ปิด","Активировать промокод":"ใช้คูปอง","Я понял":"Got it","Юридическая информация":"ข้อมูลทางกฏหมาย","шт.":"ชิ้น","Подтвердить":"ยืนยัน","Доставка":"จัดส่ง","Самовывоз":"เลือก","Другие страны":"ประเทศอื่น","Итого":"รวม","Контакты":"รายชื่อติดต่อ","Подтверждение":"การยืนยัน","Применить":"Apply","Корзина":"ตะกร้าสินค้า","Корзина пуста":"ไม่มีสินค้าในตะกร้า","Поиск по названию":"ค้นหา","Все товары":"สินค้าทั้งหมด","В магазине пока отсутствуют товары":"สินค้าไม่มีจำหน่ายในร้านค้า","Скидка":"Discount","-- Не выбрано --":"ไม่ได้เลือก","Добавить в корзину":"เพิ่มในตะกร้าสินค้า","Вернуться в каталог":"กลับสู่หน้าสินค้า","Оформить заказ":"ชำระเงิน","Товар добавлен в корзину":"เพิ่มสินค้าลงในรถเข็น","Перейти в корзину":"ไปที่รถเข็น","Продолжить покупки":"ช็อปต่อ","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"The page is unavailable for viewing all. To resolve this issue you need to connect a profile or domain name","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Unfortunately, this function was blocked because the owner of the page did not pay for it in time. If possible, please let the owner of the page know about this issue","Заголовок":"ชื่อ","Дни":"วัน","Часы":"ชั่วโมง","Минуты":"นาที","Введите корректный email":"Enter a valid email","Секунды":"วินาที","Необходимо заполнить поле":"You must fill the field","Введите корректный номер телефона":"Enter a valid phone number"});