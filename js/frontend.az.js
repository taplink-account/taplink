...
window.$app.defineLanguage("az", 0, {"Январь":"January","Февраль":"February","Март":"March","Апрель":"April","Май":"May","Июнь":"June","Июль":"July","Август":"August","Сентябрь":"September","Октябрь":"October","Ноябрь":"November","Декабрь":"December","ПН":"Bazar ertəsi","ВТ":"Çərşənbə axşamı","СР":"Çərşənbə ","ЧТ":"Cümə axşamı","ПТ":"Cümə ","СБ":"Şənbə ","ВС":"Bazar","Сделано на":"Powered by","Промокод":"Promo kod","Закрыть":"Bağla","Активировать промокод":"Promo kodu aktiv edin","Я понял":"Anladım","Юридическая информация":"Hüquqi məlumat","шт.":"ədəd.","Подтвердить":"Təsdiqlə","Доставка":"Çatdırılma","Самовывоз":"Almaq","Другие страны":"Digər ölkələr","Итого":"Ümumi","Контакты":"Əlaqələr","Подтверждение":"Təsdiq","Применить":"Tətbiq et","Корзина":"Kart","Корзина пуста":"Səbət boşdur","Поиск по названию":"Axtarış","Все товары":"Bütün məhsullar","В магазине пока отсутствуют товары":"Mağazada məhsul yoxdur","Скидка":"Endirim","-- Не выбрано --":"-- Seçilməmişdir --","Добавить в корзину":"Karta əlavə et","Вернуться в каталог":"Kataloqa geri dön.","Оформить заказ":"Sifariş verin","Товар добавлен в корзину":"Səbətə əlavə edildi","Перейти в корзину":"Səbətə keç","Продолжить покупки":"Alış-verişə davam edin","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"Səhifəyə baxmaq mümkün deyil.  Bu problemi həll etmək üçün profil və ya domen adını qoşmalısınız","На основе описания вашего профиля мы подготовили пример страницы":"Profil təsvirinizə əsasən nümunə səhifə hazırladıq","Редактировать страницу":"Səhifəni redaktə edin","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Təəssüf ki, səhifənin sahibi vaxtında ödəniş etmədiyi üçün bu funksiya bloklandı. Mümkünsə, səhifənin sahibinə bu məsələ barədə məlumat verin","Заголовок":"Başlıq","Дни":"günlük","Часы":"Saatlar","Минуты":"Dəqiqələr","Введите корректный email":"Mövcud e-poçt daxil edin","Секунды":"Saniyələr","Необходимо выбрать метод доставки":"Göndərmə üsulunu seçməlisiniz","Необходимо заполнить поле":"Sahəni doldurmalısınız","Введите корректный номер телефона":"Mövcud telefon nömrəsini daxil edin"});