...
window.$app.defineLanguage("pl", 0, {"Январь":"January","Февраль":"February","Март":"March","Апрель":"April","Май":"May","Июнь":"June","Июль":"July","Август":"August","Сентябрь":"September","Октябрь":"October","Ноябрь":"November","Декабрь":"December","ПН":"Mon","ВТ":"Tue","СР":"Wed","ЧТ":"Thu","ПТ":"Fri","СБ":"Sat","ВС":"Sun","Сделано на":"Powered by","Промокод":"Promo code","Закрыть":"Zamknąć","Активировать промокод":"Activate promo code","Я понял":"Got it","Юридическая информация":"Regulamin sklepu","шт.":"szt.","Подтвердить":"Potwierdzić","Доставка":"Dostawa","Самовывоз":"Odbiór osobisty","Другие страны":"Inne kraje","Итого":"Podsumowanie","Контакты":"Dane kontaktowe","Подтверждение":"Potwierdzenie","Применить":"Zastosować","Корзина":"Twój koszyk","Корзина пуста":"Twój koszyk jest pusty","Поиск по названию":"Czego szukasz?","Все товары":"Wszystkie przedmioty","В магазине пока отсутствуют товары":"Brak produktów w sklepie","Скидка":"Discount","-- Не выбрано --":"-- Wybierz opcję --","Добавить в корзину":"Dodaj do koszyka","Вернуться в каталог":"Przejdź do zakupów","Оформить заказ":"Złóż zamówienie","Товар добавлен в корзину":"Produkt został dodany do koszyka","Перейти в корзину":"Przejdź do koszyka","Продолжить покупки":"Kontynuuj zakupy","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"The page is unavailable for viewing all. To resolve this issue you need to connect a profile or domain name","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Unfortunately, this function was blocked because the owner of the page did not pay for it in time. If possible, please let the owner of the page know about this issue","Заголовок":"Headline","Дни":"Dni","Часы":"Zegar","Минуты":"Minut","Введите корректный email":"Podaj poprawny e-mail","Секунды":"Sekund","Необходимо заполнить поле":"To pole jest wymagane","Введите корректный номер телефона":"Podaj poprawny numer telefonu"});