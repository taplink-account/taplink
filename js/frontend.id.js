...
window.$app.defineLanguage("id", 0, {"Январь":"Januari","Февраль":"Februari","Март":"Maret","Апрель":"April","Май":"Mei","Июнь":"Juni","Июль":"Juli","Август":"Agustus","Сентябрь":"September","Октябрь":"Oktober","Ноябрь":"November","Декабрь":"Desember","ПН":"SEN","ВТ":"SEL","СР":"RAB","ЧТ":"KAM","ПТ":"JUM","СБ":"SAB","ВС":"MIN","Сделано на":" Dibuat dengan","Промокод":"Kode promo","Закрыть":"Tutup","Активировать промокод":"Mengaktifkan kode promo","Я понял":"Oke","Юридическая информация":"Informasi hukum","шт.":"pcs.","Подтвердить":"Konfirmasi","Доставка":"Pengiriman","Самовывоз":"Pickup","Другие страны":"Other countries","Итого":"Total","Контакты":"Kontak","Подтверждение":"Confirmation","Применить":"Menerapkan","Корзина":"Keranjang","Корзина пуста":"Empty cart","Поиск по названию":"Cari","Все товары":"All products","В магазине пока отсутствуют товары":"There are no products in the shop","Скидка":"Diskon","-- Не выбрано --":"-- Tidak dipilih --","Добавить в корзину":"Masukkan ke keranjang","Вернуться в каталог":"Kembali ke katalog","Оформить заказ":"Memesan","Товар добавлен в корзину":"Barang ditambahkan ke keranjang","Перейти в корзину":"Pergi ke Keranjang","Продолжить покупки":"Lanjutkan Belanja","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"Halaman tidak tersedia untuk melihat semua. Untuk mengatasi masalah ini, Anda perlu menghubungkan profil atau nama domain","На основе описания вашего профиля мы подготовили пример страницы":"Berdasarkan BIO Anda, kami membuat contoh halaman","Редактировать страницу":"Edit halaman","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Sayangnya, fungsi ini diblokir karena pemilik laman tidak membayar tepat waktu. Jika mungkin, harap beri tahu pemilik laman tentang masalah ini","Заголовок":"Judul","Дни":"Berhari-hari","Часы":"Jam","Минуты":"Menit","Введите корректный email":"Masukkan email yang valid","Секунды":"Detik","Необходимо заполнить поле":"Anda harus mengisi kolom","Введите корректный номер телефона":"Masukkan nomor telepon yang valid"});