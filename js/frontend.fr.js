...
window.$app.defineLanguage("fr", 0, {"Январь":"Janvier","Февраль":"Février","Март":"Mars","Апрель":"Avril","Май":"Mai","Июнь":"Juin","Июль":"Juillet","Август":"Août","Сентябрь":"Septembre","Октябрь":"Octobre","Ноябрь":"Novembre","Декабрь":"Décembre","ПН":"LUN","ВТ":"MAR","СР":"MER","ЧТ":"JEU","ПТ":"VEN","СБ":"SAM","ВС":"DIM","Сделано на":"Fabriqué par","Промокод":"Promo code","Закрыть":"Fermer","Активировать промокод":"Activate promo code","Я понял":"Got it","Юридическая информация":"Information légale","шт.":"pcs.","Подтвердить":"Confirmer","Доставка":"Livraison","Самовывоз":"Ramasser","Другие страны":"Autres pays","Итого":"Total","Контакты":"Contacts","Подтверждение":"Confirmation","Применить":"Appliquer","Корзина":"Chariot","Корзина пуста":"Panier vide","Поиск по названию":"Chercher","Все товары":"Tous les produits","В магазине пока отсутствуют товары":"Il n\\'y a aucun produit dans la boutique","Скидка":"Discount","-- Не выбрано --":"-- Pas choisi --","Добавить в корзину":"Ajouter au panier","Вернуться в каталог":"Retour au catalogue","Оформить заказ":"Check-out","Товар добавлен в корзину":"Article ajouté au panier","Перейти в корзину":"Aller au panier","Продолжить покупки":"Continuer vos achats","Страница недоступна для просмотра всем. Для решения этой проблемы вам необходимо подключить профиль или доменное имя":"The page is unavailable for viewing all. To resolve this issue you need to connect a profile or domain name","На основе описания вашего профиля мы подготовили пример страницы":"Based on your BIO, we created an example of the page","Редактировать страницу":"Edit page","К сожалению эта функция была заблокирована, так как владелец страницы своевременно не оплатил ее. Если вас не затруднит, сообщите владельцу страницы о данной проблеме":"Unfortunately, this function was blocked because the owner of the page did not pay for it in time. If possible, please let the owner of the page know about this issue","Заголовок":"Headline","Дни":"Jours","Часы":"Heures","Минуты":"Minutes","Введите корректный email":"Entrer un email valide","Секунды":"Secondes","Необходимо заполнить поле":"Vous devez remplir le champ","Введите корректный номер телефона":"Entrez un numéro de téléphone valide"});